...
public interface IActionBuilder<TEntity> {
    ...
    public IActionBuilder<TEntity> AddEdit(string action = null, string controller = null,
        object routeValues = null, string text = "Edit", string title = "Edit", bool verification = true, string cssClass = "", string titleModal = "");
...
public class ActionBuilder<TEntity> : IActionBuilder<TEntity> {
    ...
    private static readonly string SvgPencil = HeroIcons.Render("pencil-square", HeroIcons.IconStyle.Outline, "4");
    ...
    public IActionBuilder<TEntity> AddEdit(string action = null, string controller = null,
        ...
        routeValues ??= new { id };
        var link = LinkGenerator.GetPathByAction(HttpContext, action, controller, routeValues);
        Html += $"<a data-title=\"{titleModal}\" href=\"{link}\" class=\"grid-action-btn {cssClass}\" data-tooltip=\"{text}\">{SvgPencil}</a>";
        return this;
    }
