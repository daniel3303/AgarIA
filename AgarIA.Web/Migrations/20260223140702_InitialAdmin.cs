        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiPlayerCount = table.Column<int>(type: "INTEGER", nullable: false),
                    TotalMass = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalMass = table.Column<double>(type: "REAL", nullable: false),
                    FoodEaten = table.Column<int>(type: "INTEGER", nullable: false),
                    PlayersKilled = table.Column<int>(type: "INTEGER", nullable: false),
                    PlayerMassEaten = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerGameStats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerGameStats_GameRounds_GameRoundId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerGameStats_GameRoundId",
